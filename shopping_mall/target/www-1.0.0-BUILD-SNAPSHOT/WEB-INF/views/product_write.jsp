	...
	<form id="prd_write_frm" enctype="multipart/form-data">
		...
		<div class="product_insert">
		    <ul>
		        <li>대메뉴 카테고리</li>
		        <li>
		            <select class="product_input1" name="cate_name">
		    ...
		    <ul>
		        <li>상품 부가설명</li>
		        <li>
		            <input type="text" name="p_summary" class="product_input4" maxlength="200"> <span class="help_text">※ 상품 부가설명은 최대 200자까지만 적용할 수 있습니다.</span>
		        </li>
		    </ul>
		    <ul>
		        <li>판매가격</li>
		    ...
		    <ul>
		        <li>할인가격</li>
		        <li>
		            <input type="text" name="p_dc_money" class="product_input3" maxlength="7" value="0" readonly> <span class="help_text">※ 할인율이 0%일 경우 할인가격은 0으로 처리 합니다.</span>
		        </li>
		    </ul>
		    <ul>
		        <li>상품재고</li>
		        <li>
		            <input type="text" name="p_stock" class="product_input3" maxlength="4" value="0">EA <span class="help_text">※ 숫자만 입력하세요. 재고가 0일 경우 soldout이 됩니다.</span>
		        </li>
		    </ul>
		    <ul>
		        <li>판매 유/무</li>
		    ...
		    <ul style="height: 400px;">
		        <li>상품 상세설명</li>
		        <li>
		            <textarea class="product_text1" name="p_desc"></textarea>
		        </li>
		    </ul>
		</div>
