...
<main class="maincss">
<form id="cate_frm">
	<input type="hidden" value="${result.c_no}" name="c_no">
	<section>
	    <p>카테고리 등록 페이지</p>
	    <div class="cate_insert">
	        ...
	        <ul>
	            <li>대메뉴 코드</li>
	            <li>
	                <input type="text" class="cate_input2" name="cate_code" list="lg_menu" value='${result.cate_code}'>
	                <datalist id="lg_menu">
	                    <option>01</option>
	                    <option>02</option>
	                </datalist>
	        ...
	        <ul>
	            <li>대메뉴명</li>
	            <li>
	            	<input type="text" class="cate_input3" name="cate_name" value='${result.cate_name}'>
	            	<!--<label><input type="checkbox" style="margin-left:10px; margin-right: 5px;">대메뉴만 생성</label>-->
	            </li>
	        ...
	        <ul>
	            <li>사용 유/무</li>
	            <li>
	                <label class="rmargin"><input type="radio" name="cate_use" value="Y" data-radio='${result.cate_use}'>사용함 </label>
	                <label class="rmargin"><input type="radio" name="cate_use" value="N" data-radio='${result.cate_use}'>사용안함</label>
	            </li>
	    ...
	    <div class="subpage_view4" style="text-align:center;">
	        ...
	        <input type="button" value="카테고리 수정" title="카테고리 수정" class="p_button p_button_color2" onclick="make_cate('modify')">
	        </span>
	    </div>
	</section>
</form>
